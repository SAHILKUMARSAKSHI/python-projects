...
class Stopwatch(tk.Tk):
    def __init__(self):
        ...
        self.start_button = tk.Button(self, text="Start", width=10, height=2, font=("Helvetica", 14),
                                      command=self.start)
        ...
        self.reset_button = tk.Button(self, text="Reset", width=10, height=2, font=("Helvetica", 14),
                                      command=self.reset)
